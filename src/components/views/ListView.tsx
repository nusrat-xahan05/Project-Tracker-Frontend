    ...
    return (
        <div className="flex flex-col h-screen max-h-screen bg-white border border-gray-200 rounded-lg overflow-hidden relative">
            ...
            <div className="grid grid-cols-12 gap-4 p-3 bg-gray-50 border-b border-gray-200 text-sm font-semibold text-gray-600 z-20 shadow-sm shrink-0">
                <div className="col-span-3 cursor-pointer hover:text-blue-600 flex items-center select-none" onClick={() => handleSort('title')}>
                        ...
                        {visibleTasks.map((task) => {
                            ...
                            return (
                                <div
                                    ...
                                    <div className="col-span-3 font-medium text-gray-800 truncate" title={task.title}>{task.title}</div>
                                    ...
                                    <div className="col-span-1 text-sm text-gray-600 truncate">{task.status}</div>
